 ...
 * @package WordPress
 * @subpackage wbsPress
 * @since wbsPress 1.1.0
 */

if ( ! class_exists( 'wbsPress_protocol_relative_theme_assets' ) ) :
	class wbsPress_protocol_relative_theme_assets {
		/**
	...
	$wbsPress_protocol_relative_theme_assets = new wbsPress_protocol_relative_theme_assets;
endif;
